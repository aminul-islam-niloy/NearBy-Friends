...
namespace NearBy_Friends.Controllers
{
    public class FriendsController : Controller
    {
        ...
        {
            var friends = await _context.Friends.Include(f => f.Address).ToListAsync();
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,PhoneNumer,Age,Profession,Hobbies,Address")] Friend friend)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,PhoneNumer,Age,Profession,Hobbies,Address")] Friend friend)
        {
            if (id != friend.Id)
            {
                return NotFound();
